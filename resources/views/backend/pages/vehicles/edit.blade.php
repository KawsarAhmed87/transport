                ...
                <form action="{{ route('admin.vehicles.update', $vehicle->id) }}" method="POST" autocomplete="off">
                  ...
                  <table class="table table-bordered">
                    ...
                    <tr>
                      ...
                      <td width="35%"><input type="text" class="form-control" value="{{$vehicle->chasis_no}}"  name="chasis_no"></select>
                      </td>
                    ...
                    <tr>
                      ...
                      <td width="35%"><input type="date" class="form-control" value="{{$vehicle->tax}}"  name="tax"></select>
                      </td>
                    ...
                    <tr>
                      ...
                      <td width="35%"><input type="date" class="form-control" value="{{$vehicle->cylinder}}"  name="cylinder"></select>
                      </td>
