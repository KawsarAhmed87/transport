    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <li class="breadcrumb-item"><a href="{{route('admin.brands.index')}}" class="btn btn-success">Brand list</a></li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <form action="{{ route('admin.brands.update', $brand->id) }}" method="POST" autocomplete="off">
                  @method('PUT')
                  @csrf
                  <div class="form-row">
